                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <span class="d-none d-sm-inline">
                                <ap-dropdown :data="{ classes: { 'btn': true, 'btn-primary': true, 'dropdown-toggle': true }, name: 'Ещё' }">
            ...
            <div class="container-xl">
                <div class="row row-deck row-cards">
                            ...
                            <div class="card-table table-responsive">
                                <table class="table table-vcenter">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm" style="background-image: url(/images/avatars/000m.jpg)"></span>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm" style="background-image: url(/images/avatars/002m.jpg)"></span>
                                            </td>
                                            <td class="td-truncate">
                                        ...
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm" style="background-image: url(/images/avatars/003m.jpg)"></span>
                                            </td>
                                            <td class="td-truncate">
                                        ...
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm" style="background-image: url(/images/avatars/000f.jpg)"></span>
                                            </td>
                                            <td class="td-truncate">
                                        ...
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm" style="background-image: url(/images/avatars/001f.jpg)"></span>
                                            </td>
                                            <td class="td-truncate">
                            ...
                            <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                                <div class="divide-y">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/002m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                                    It's
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/003m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/000f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/001f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/002f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/003f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/006m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/004f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/007m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/009m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/010m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/005f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/images/avatars/006f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener" style="background-image: url(/images/sponsor-banner-homepage.svg)" aria-label="Sponsor Tabler!">
